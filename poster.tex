...
Such quantum simulations chemistry would enable a leap forward in our understanding of fundamental chemistry, and reduce the need for lengthy and expensive trial-and-error techniques used to develop new medicines and materials.
  \end{minipage}
  \end{center}
\end{figure}
\section*{Key terms}
