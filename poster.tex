...
\begin{highlightbox}[UCLdarkblue!20!white]
	\textbf{Qubit} A quantum bit of information. A classical bit represents classical information and is encoded in 0s and 1s. A qubit is in a superposition of two states, and is in the 0 and 1 state simultaneously.
\end{highlightbox}
