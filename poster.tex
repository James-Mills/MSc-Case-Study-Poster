...
The qubits used to run the algorithms were a type of charge qubit (the qubit is in a superposition of two different charges - see Superposition box) that are kept at very low temperatures. It is similar to the IMB qubit shown in Figure 1.
  \end{minipage}
  \end{center}
