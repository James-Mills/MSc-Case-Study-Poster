\documentclass[16pt,landscape,color=UCLdarkred,margin=3cm]{uclposter}
...
\begin{highlightbox}[UCLstone!50!white]
	\textbf{Superposition} A qubit can be in both states of '0' and '1' at the same time, but a classical bit is either `0' or `1'.
\end{highlightbox}
