...
The variational quantum eigensolver (VQE) and the phase estimation algorithm (PEA) are two types of algorithm which are performed using the qubits to find molecular energies. A special type of qubit known as an Xmon is used to run the algorithms. The Xmon runs using a superposition of ``charge" states.
