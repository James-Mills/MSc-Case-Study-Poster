...
The work by the researchers on the paper `Scalable Quantum Simulation of Molecular Energies' uses qubits kept at very low temperatures to run algorithms to find out information about the fundamental properties of molecules.
